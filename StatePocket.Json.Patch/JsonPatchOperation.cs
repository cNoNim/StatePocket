...
public abstract class JsonPatchOperation
{
    ...
    [SetsRequiredMembers]
    protected JsonPatchOperation(string path) => Path = path;
    ...
    protected static JsonPointer ParsePath(string path)
    {
    ...
    private static JsonNode GetObjectChild(JsonObject jsonObject, string segment, JsonPointer parsedPath)
    {
    ...
    private static JsonNode GetArrayChild(JsonArray jsonArray, string segment, JsonPointer parsedPath)
    {
